...
(()=>{
    ...
    function(e) {
        ...
        e.fromBrowserify = function() {
            return t("prod", "14", "1066", "0", "UNVERSIONED", "UNVERSIONED", "3")
        }
    }(Q || (Q = {})),
    function(e) {
    ...
    const zr = "data-enable-grammarly"
      ...
      , Yr = ["changed-user", "changed-plan", "changed-dialect", "cleanup", "editor-fix", "llama-action", "close-current-tab"];
    function Xr(e, t) {
        let n = e.parentNode;
        for (; null !== n; ) {
            if (Qr(n, t))
    ...
    class Qs {
        ...
        closeCurrentTab() {
            return Bi.create(((e,t)=>{
                this.getActiveTab().then((n=>{
                    n && n.id && this._chrome.tabs.remove(n.id, (()=>{
                        Ps((()=>e()), t)
                    }
                    ))
                }
