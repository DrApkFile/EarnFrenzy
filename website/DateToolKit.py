...
def calculate_difference(start, end):
    ...
    total_days = (datetime.strptime(end, "%Y-%m-%d").date() - datetime.strptime(start, "%Y-%m-%d").date()).days
    day_what = (dt.date.today() - datetime.strptime(start, "%Y-%m-%d").date()).days

    return total_days - day_what

# # Example usage:
# date_string = "2023-11-07"
# formatted_date = clean_date(date_string, style="MDY")
# print(formatted_date) # November 7th, 2023
